...
pid.o: ${S}/lib/pid.c
	${COMPILE.c} ${S}/lib/pid.c
SRCS+=${S}/lib/pid.c
OBJS+=pid.o

coremap.o: ${S}/lib/coremap.c
	${COMPILE.c} ${S}/lib/coremap.c
SRCS+=${S}/lib/coremap.c
OBJS+=coremap.o
...
pagetable.o: ${S}/vm/pagetable.c
	${COMPILE.c} ${S}/vm/pagetable.c
SRCS+=${S}/vm/pagetable.c
OBJS+=pagetable.o
